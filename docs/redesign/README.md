...
**Status:** options ready for the owner's decision (2026-09-24). Nothing is built yet.
...
| `elocution-focus.md` | **Draft revision (2026-09-25).** The owner chose articulation and elocution as the focus, with mumbling as the main problem. Replaces the goals, English content order, session plan, and build order of `design-options.md`. Section 3 draws on `docs/research/mumbling-note.md`. |
