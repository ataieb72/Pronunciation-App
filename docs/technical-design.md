...
| `packages/dsp` | Pure TypeScript audio code. Built: band-limited resampler, PCM16/WAV encoder and decoder, level measures, voice activity detection (streaming), quality gate, FFT, Praat-style pitch tracker, intensity, silences, syllable nuclei, pauses and articulation rate. Next: speech level and fade | R1, R2 |
