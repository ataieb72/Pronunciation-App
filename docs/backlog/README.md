...
|------|------|-------|--------|
| [R1](epics/R1-reset-and-phone-test.md) Reset and phone test | Clean v2 workspace; Worker pairs the phone and issues Azure tokens; go/no-go on the Pixel | 7 (5 ✅, 2 waiting on the phone) | 🔄 |
