...
| [R3](epics/R3-clarity-core.md) Clarity core | **Slice 1:** baselines, clear-speech pairs, block summaries, 5/10-min sessions, both languages, no cloud scoring | 7 (T01–T06 ✅; T07 waits on practice takes) | 🔄 |
...
- After the first R3 practice sessions: send one ZIP of takes in the chat (the voice check, R2-T08).
